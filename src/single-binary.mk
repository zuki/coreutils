...
src_libsinglebin_hostname_a_DEPENDENCIES = $(src_hostname_DEPENDENCIES)
...
src_libsinglebin_chroot_a_DEPENDENCIES = $(src_chroot_DEPENDENCIES)
...
src_libsinglebin_df_a_DEPENDENCIES = $(src_df_DEPENDENCIES)
...
src_libsinglebin_hostid_a_DEPENDENCIES = $(src_hostid_DEPENDENCIES)
...
src_libsinglebin_nice_a_DEPENDENCIES = $(src_nice_DEPENDENCIES)
...
src_libsinglebin_stdbuf_a_DEPENDENCIES = $(src_stdbuf_DEPENDENCIES)
...
src_libsinglebin_stty_a_DEPENDENCIES = $(src_stty_DEPENDENCIES)
...
src_libsinglebin___a_DEPENDENCIES = $(src___DEPENDENCIES)
...
src_libsinglebin_b2sum_a_SOURCES =   src/digest.c src/blake2/blake2.h src/blake2/blake2-impl.h src/blake2/blake2b-ref.c src/blake2/b2sum.c src/blake2/b2sum.h
src_libsinglebin_b2sum_a_DEPENDENCIES = $(src_b2sum_DEPENDENCIES)
...
src_libsinglebin_base64_a_DEPENDENCIES = $(src_base64_DEPENDENCIES)
...
src_libsinglebin_base32_a_DEPENDENCIES = $(src_base32_DEPENDENCIES)
...
src_libsinglebin_basenc_a_DEPENDENCIES = $(src_basenc_DEPENDENCIES)
...
src_libsinglebin_basename_a_DEPENDENCIES = $(src_basename_DEPENDENCIES)
...
src_libsinglebin_cat_a_DEPENDENCIES = $(src_cat_DEPENDENCIES)
...
src_libsinglebin_chcon_a_DEPENDENCIES = $(src_chcon_DEPENDENCIES)
...
src_libsinglebin_chmod_a_DEPENDENCIES = $(src_chmod_DEPENDENCIES)
...
src_libsinglebin_cksum_a_SOURCES =   $(src_b2sum_SOURCES) src/sum.c src/sum.h src/cksum.c src/cksum.h src/crctab.c
src_libsinglebin_cksum_a_ldadd =   $(LIB_CRYPTO)  $(cksum_avx512_ldadd)  $(cksum_avx2_ldadd)  $(cksum_pclmul_ldadd)  $(cksum_vmull_ldadd)
src_libsinglebin_cksum_a_DEPENDENCIES = $(src_cksum_DEPENDENCIES)
...
src_libsinglebin_cksum_a_CPPFLAGS =   -DHASH_ALGO_CKSUM=1 -DHAVE_CONFIG_H $(AM_CPPFLAGS)
# Command comm
noinst_LIBRARIES += src/libsinglebin_comm.a
src_libsinglebin_comm_a_SOURCES = src/comm.c
src_libsinglebin_comm_a_DEPENDENCIES = $(src_comm_DEPENDENCIES)
...
src_libsinglebin_csplit_a_DEPENDENCIES = $(src_csplit_DEPENDENCIES)
...
src_libsinglebin_cut_a_DEPENDENCIES = $(src_cut_DEPENDENCIES)
...
src_libsinglebin_date_a_SOURCES =   src/date.c src/show-date.c
...
src_libsinglebin_dircolors_a_DEPENDENCIES = $(src_dircolors_DEPENDENCIES)
...
src_libsinglebin_dirname_a_DEPENDENCIES = $(src_dirname_DEPENDENCIES)
...
src_libsinglebin_du_a_SOURCES =   src/du.c src/show-date.c
src_libsinglebin_du_a_DEPENDENCIES = $(src_du_DEPENDENCIES)
...
src_libsinglebin_echo_a_DEPENDENCIES = $(src_echo_DEPENDENCIES)
...
src_libsinglebin_env_a_DEPENDENCIES = $(src_env_DEPENDENCIES)
...
src_libsinglebin_expand_a_DEPENDENCIES = $(src_expand_DEPENDENCIES)
...
src_libsinglebin_expr_a_ldadd =   $(LIBGMP)
src_libsinglebin_expr_a_DEPENDENCIES = $(src_expr_DEPENDENCIES)
...
src_libsinglebin_false_a_DEPENDENCIES = $(src_false_DEPENDENCIES)
...
src_libsinglebin_fmt_a_DEPENDENCIES = $(src_fmt_DEPENDENCIES)
...
src_libsinglebin_fold_a_DEPENDENCIES = $(src_fold_DEPENDENCIES)
...
src_libsinglebin_groups_a_DEPENDENCIES = $(src_groups_DEPENDENCIES)
...
src_libsinglebin_head_a_DEPENDENCIES = $(src_head_DEPENDENCIES)
...
src_libsinglebin_id_a_DEPENDENCIES = $(src_id_DEPENDENCIES)
...
src_libsinglebin_join_a_DEPENDENCIES = $(src_join_DEPENDENCIES)
...
src_libsinglebin_kill_a_DEPENDENCIES = $(src_kill_DEPENDENCIES)
...
src_libsinglebin_link_a_DEPENDENCIES = $(src_link_DEPENDENCIES)
...
src_libsinglebin_logname_a_DEPENDENCIES = $(src_logname_DEPENDENCIES)
...
src_libsinglebin_md5sum_a_SOURCES =   src/digest.c
src_libsinglebin_md5sum_a_ldadd =   $(LIB_CRYPTO)
src_libsinglebin_md5sum_a_DEPENDENCIES = $(src_md5sum_DEPENDENCIES)
...
src_libsinglebin_mkdir_a_DEPENDENCIES = $(src_mkdir_DEPENDENCIES)
...
src_libsinglebin_mkfifo_a_DEPENDENCIES = $(src_mkfifo_DEPENDENCIES)
...
src_libsinglebin_mknod_a_DEPENDENCIES = $(src_mknod_DEPENDENCIES)
...
src_libsinglebin_mv_a_DEPENDENCIES = $(src_mv_DEPENDENCIES)
...
src_libsinglebin_nl_a_DEPENDENCIES = $(src_nl_DEPENDENCIES)
...
src_libsinglebin_nproc_a_DEPENDENCIES = $(src_nproc_DEPENDENCIES)
...
src_libsinglebin_nohup_a_DEPENDENCIES = $(src_nohup_DEPENDENCIES)
...
src_libsinglebin_numfmt_a_DEPENDENCIES = $(src_numfmt_DEPENDENCIES)
...
src_libsinglebin_od_a_DEPENDENCIES = $(src_od_DEPENDENCIES)
...
src_libsinglebin_paste_a_DEPENDENCIES = $(src_paste_DEPENDENCIES)
...
src_libsinglebin_pathchk_a_DEPENDENCIES = $(src_pathchk_DEPENDENCIES)
...
src_libsinglebin_printenv_a_DEPENDENCIES = $(src_printenv_DEPENDENCIES)
...
src_libsinglebin_printf_a_DEPENDENCIES = $(src_printf_DEPENDENCIES)
...
src_libsinglebin_pwd_a_DEPENDENCIES = $(src_pwd_DEPENDENCIES)
...
src_libsinglebin_readlink_a_DEPENDENCIES = $(src_readlink_DEPENDENCIES)
...
src_libsinglebin_realpath_a_DEPENDENCIES = $(src_realpath_DEPENDENCIES)
...
src_libsinglebin_rm_a_DEPENDENCIES = $(src_rm_DEPENDENCIES)
...
src_libsinglebin_rmdir_a_DEPENDENCIES = $(src_rmdir_DEPENDENCIES)
...
src_libsinglebin_runcon_a_DEPENDENCIES = $(src_runcon_DEPENDENCIES)
...
src_libsinglebin_seq_a_DEPENDENCIES = $(src_seq_DEPENDENCIES)
...
src_libsinglebin_sha1sum_a_SOURCES =   src/digest.c
src_libsinglebin_sha1sum_a_ldadd =   $(LIB_CRYPTO)
src_libsinglebin_sha1sum_a_DEPENDENCIES = $(src_sha1sum_DEPENDENCIES)
...
src_libsinglebin_sha224sum_a_SOURCES =   src/digest.c
src_libsinglebin_sha224sum_a_ldadd =   $(LIB_CRYPTO)
src_libsinglebin_sha224sum_a_DEPENDENCIES = $(src_sha224sum_DEPENDENCIES)
...
src_libsinglebin_sha256sum_a_SOURCES =   src/digest.c
src_libsinglebin_sha256sum_a_ldadd =   $(LIB_CRYPTO)
src_libsinglebin_sha256sum_a_DEPENDENCIES = $(src_sha256sum_DEPENDENCIES)
...
src_libsinglebin_sha384sum_a_SOURCES =   src/digest.c
src_libsinglebin_sha384sum_a_ldadd =   $(LIB_CRYPTO)
src_libsinglebin_sha384sum_a_DEPENDENCIES = $(src_sha384sum_DEPENDENCIES)
...
src_libsinglebin_sha512sum_a_SOURCES =   src/digest.c
src_libsinglebin_sha512sum_a_ldadd =   $(LIB_CRYPTO)
src_libsinglebin_sha512sum_a_DEPENDENCIES = $(src_sha512sum_DEPENDENCIES)
...
src_libsinglebin_shuf_a_DEPENDENCIES = $(src_shuf_DEPENDENCIES)
...
src_libsinglebin_stat_a_DEPENDENCIES = $(src_stat_DEPENDENCIES)
...
src_libsinglebin_sum_a_SOURCES =   src/sum.c src/sum.h src/digest.c
src_libsinglebin_sum_a_DEPENDENCIES = $(src_sum_DEPENDENCIES)
...
src_libsinglebin_sum_a_CPPFLAGS =   -DHASH_ALGO_SUM=1 $(AM_CPPFLAGS)
# Command sync
...
src_libsinglebin_tr_a_DEPENDENCIES = $(src_tr_DEPENDENCIES)
...
src_libsinglebin_true_a_DEPENDENCIES = $(src_true_DEPENDENCIES)
...
src_libsinglebin_truncate_a_DEPENDENCIES = $(src_truncate_DEPENDENCIES)
...
src_libsinglebin_tsort_a_DEPENDENCIES = $(src_tsort_DEPENDENCIES)
...
src_libsinglebin_tty_a_DEPENDENCIES = $(src_tty_DEPENDENCIES)
...
src_libsinglebin_uname_a_DEPENDENCIES = $(src_uname_DEPENDENCIES)
...
src_libsinglebin_unexpand_a_DEPENDENCIES = $(src_unexpand_DEPENDENCIES)
...
src_libsinglebin_uniq_a_DEPENDENCIES = $(src_uniq_DEPENDENCIES)
...
src_libsinglebin_wc_a_ldadd =   $(wc_avx2_ldadd)
src_libsinglebin_wc_a_DEPENDENCIES = $(src_wc_DEPENDENCIES)
...
src_libsinglebin_whoami_a_DEPENDENCIES = $(src_whoami_DEPENDENCIES)
...
src_libsinglebin_yes_a_DEPENDENCIES = $(src_yes_DEPENDENCIES)
